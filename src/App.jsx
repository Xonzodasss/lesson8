...
function App() {
  ...
  return (
    <div className='ota'>
      <Card ism="Emily Johnson" kasbi="Product Manager" soha="Product Development" ></Card>
      <Card ism="Arjun Patel" kasbi="Software Engineer" soha="Technology" ></Card>
      <Card ism="Carlos Hernández" kasbi="UI Designer" soha="Design" ></Card>
      <Card ism="Amina Idris" kasbi="Marketing Specialist" soha="Marketing" ></Card>
